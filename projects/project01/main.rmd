...
def check_file_structure(filename):
    ...
    with open(filename, 'r') as f:
        ...
        for line in f:
            line = line.strip()  # removes the white spaces from the beginning and ends
            
            if line.startswith('##'):
                meta_headers.append(line)
            elif line.startswith('#CHROM'):  # Fixed: was missing the #
                column_header = line
            else:
...
#used claude sonnet 4 on 2509-13 with the question what is
