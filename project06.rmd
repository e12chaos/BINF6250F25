...
def get_min_distance(matrix):
    ...
    # Step 1: Start with a very large minimum value; This helops to ensures any real distance will be smaller
    min_val = float('inf')  # infinity
    pos = (0, 0)  # placeholder position
    
    #Step 2: Search through the matrix
    n = matrix.shape[0]  # number of rows (same as columns for square matrix)
    
    for i in range(n):
        for j in range(n):
            # Step 3: Skip diagonal elements - since they will always be the best (0)
            if i == j:
                continue  # Skip to next iteration
            
            # Step 4: Check if this is the new minimum
...
>>>>>>> 8dc3fc2eace62e0b4570507abdf53cd534fa771d
