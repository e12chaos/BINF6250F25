...
def neighbor_joining(
    ...
    Examples:
        ...
        18
    """
     #Step 1: INITIALIZATION: We need copies so we don't modify the originals
    ...
    while n > 2:
        print(f"  Iteration {len(labels) - n + 1}: {n} active nodes")
        ...
        for i in range(n):
         ...
         # STEP 4: Find Minimum Q(i,j): The pair with minimum Q value are the "neighbors" to join
        ...
        print(f"    Joining nodes [{i}] {nodes[i]} and [{j}] {nodes[j]}")
```
